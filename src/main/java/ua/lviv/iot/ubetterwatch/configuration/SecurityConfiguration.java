...
//import ua.lviv.iot.ubetterwatch.security.jwt.JwtConfigurer;
...
//
//    @Autowired
//    public SecurityConfiguration(SupervisorDetailsService supervisorDetailsService, JwtTokenProvider jwtTokenProvider) {
...
//                .and()
//                .authorizeRequests()
//                .antMatchers("/api/oleg").permitAll()
